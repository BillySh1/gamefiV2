export default {
  ...
  intro_err: "Xiao Bing",
  stkae_ing: "Farming",
  stake_select: "Please select",
  stake_start: "start",
  stake_back: "Back to Home",
  city_0: "Fuyu",
  city_1: "Yucheng",
  city_2: "Sishui",
  city_3: "Niang",
  city_4: "Ningguan",
  city_5: "Bozhai",
  stake_think: "Think about",
  stake_next: "Next",
  stkae_excute: "Excute",
  stake_mission: "Mission",
  stake_time: "Time for",
  day: "day",
  power_up: "Power up",
  stake_mention_1: "MDAO with 10% combat power can be pledged",
  stake_mention_2: "This prompts 1% of the total combat power",
  stkae_times: "Already 0 time",
  stake_fuli: "Compound interest No",
  mission_0: "Chihou",
  mission_1: "Saodang",
  mission_2: "Zhuzha",
  back: "Back",
  cur_power: "Current Power",
  cur_total_power: "Current total power",
  total_num: "Current total heroes",
  selected: "Selected",
  stake_pull: "Cancel Select",
  golden_bonus: "Gold Bonus",
  no_golden: "No gold bonus",
  continue_add: "Keep adding",
  stake_go: "Stake",
  card_upgrade: "Card Upgrade",
  breakthrough: "Break",
  go_to_store: "Go to store",
  need_cost: "Need to cost",
  upgrade_com: "Yuling ping",
  now_have: "Now have",
  number: "number",
  lack_number: "Not enough",
  you_will: "You will",
  break_tip: "Breakthrough and rise star",
  breaked_power: "Power after break",
  cannot_break: "Not enough level to break",
  have_to_mix: "You are full of stars, please go to advanced",
  cur_pro: "Current Properties",
  upgraded_pro: "Post-upgrade properties",
  one_key_update: "One key update",
  confirm_update: "Confirm update",
  you_will_use: "You will use",
  to: "to",
  update_second: "to upgrade?",
  update_cost_tip1: "It will cost a total of",
  update_cost_tip2:
    "When the number of items in the backpack is not enough, upgrade intelligently according to the number of items currently possessed",
  cannot_update: "Can not continue to upgrade, please go to breakthrough",
  have_to_break: "You are full, please go to advanced",

  obtain_early:'Obtain early',
  early_tip:'Are you sure that you will receive benefits in advance?',
  early_tip_2:'Claiming in advance will result in a 70% revenue decline',
  cur_income:'Your current benefit is',
  add_again:'additional pledge',
  add_rule:'Additional pledge MDAO rules',
  check_map:'Check the map',
  all_power:'Network total power',
  all_income_valid:'Network valid income',
  rest_time:'Rest time',
  mission_rest_time:'Remaining Time',
  break_stake_tip:'Stopping the battle in the middle will attenuate the revenue of the expedition',
  already_income:'cumulative income',
  current_his_income:'Current historical cumulative income',
  bonus_per_block:'Bonus per block',
  invite_income:'Promotion revenue',
  staked:'Currently pledged',
  can_stake:'Currently pledgeable',
  rule_intro:'Rules Description',
  stake:'Stake',
  cur_mission_income:'current mission reward',
  release_card:'Release card',
  add_continue:'continue to pledge',
  check:'Check',
  total_own_power:'Total power',
  origin_power:'Original Army',
  added_power_up:'Additional increase',
  hour:'hour',
  minute:'min'
};
