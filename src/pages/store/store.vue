    ...
    <div class="content">
      ...
      <div class="store_zone">
        <div class="store_inner">
          ...
          />
          <img class="store_img" src="https://cryptorich3.mypinata.cloud/ipfs/QmcFsLUaLoDqCKoQsHompg1stZheKthySUPkbndKTBPs1y/rich/assets/store/store.png" />
          <img
            v-show="showRight"
            class="right"
          ...
          <div class="goods" @click="goodsClick">
            <div class="goods_inner">
              <div class="goods_text">
                <img src="https://cryptorich3.mypinata.cloud/ipfs/QmcFsLUaLoDqCKoQsHompg1stZheKthySUPkbndKTBPs1y/rich/assets/store/item/text_bg.svg" alt="" />
...
export default {
  ...
  setup() {
      ...
      storeInfos: [
        {
          key: 0,
          name: "战备",
          img: "https://cryptorich3.mypinata.cloud/ipfs/QmcFsLUaLoDqCKoQsHompg1stZheKthySUPkbndKTBPs1y/rich/assets/store/type0.png",
        },
        {
          key: 1,
          name: "神谕",
          img: "https://cryptorich3.mypinata.cloud/ipfs/QmcFsLUaLoDqCKoQsHompg1stZheKthySUPkbndKTBPs1y/rich/assets/store/type1.png",
        },
        {
          key: 2,
          name: "奇珍",
          img: "https://cryptorich3.mypinata.cloud/ipfs/QmcFsLUaLoDqCKoQsHompg1stZheKthySUPkbndKTBPs1y/rich/assets/store/type2.png",
        },
      ],
      goodsIndex: 0,
    ...
    const mainImg = computed(() => {
      return `https://cryptorich3.mypinata.cloud/ipfs/QmcFsLUaLoDqCKoQsHompg1stZheKthySUPkbndKTBPs1y/rich/assets/store/type${data.curType}.png`;
    });
...
.container {
  width: 100%;
  height: 100%;
  background: url("https://cryptorich3.mypinata.cloud/ipfs/QmcFsLUaLoDqCKoQsHompg1stZheKthySUPkbndKTBPs1y/rich/assets/store/store_bg.png") no-repeat;
