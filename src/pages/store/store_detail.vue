      ...
      <div class="left_c">
        <div class="img_box">
          <img
            ...
            :src="info.img"
          />
          <img class="img_bg" src="https://cryptorich3.mypinata.cloud/ipfs/QmTLaiRRXJ1BaDbxb92T3cfyN9xMMyD1GuWaxHXGQSFhQg/rich/assets/store/buy_item_bg.png" />
        </div>
      </div>
      <div class="right_c">
        <img class="blood" src="https://cryptorich3.mypinata.cloud/ipfs/QmTLaiRRXJ1BaDbxb92T3cfyN9xMMyD1GuWaxHXGQSFhQg/rich/assets/mint/blood.png" alt="" />
        <div class="right_c_title">
          ...
          <div class="right_c_price">
            <img
              ...
              :src="
                payment == 1
                  ? 'https://cryptorich3.mypinata.cloud/ipfs/QmTLaiRRXJ1BaDbxb92T3cfyN9xMMyD1GuWaxHXGQSFhQg/rich/assets/exchange/coin.png'
                  : 'https://cryptorich3.mypinata.cloud/ipfs/QmTLaiRRXJ1BaDbxb92T3cfyN9xMMyD1GuWaxHXGQSFhQg/rich/assets/common/mmc.png'
              "
            />
        ...
        <div class="right_c_action">
          <div class="input_box">
            ...
            />
            <div class="ipt_bg">
              <img class="ipt_img" src="https://cryptorich3.mypinata.cloud/ipfs/QmTLaiRRXJ1BaDbxb92T3cfyN9xMMyD1GuWaxHXGQSFhQg/rich/assets/mint/input.png" alt="" />
              <input
                v-model="buyValue"
                class="input"
                @input="
          ...
          <div class="right_c_btn" @click="btnClick">
            <img class="btn_img" src="https://cryptorich3.mypinata.cloud/ipfs/QmTLaiRRXJ1BaDbxb92T3cfyN9xMMyD1GuWaxHXGQSFhQg/rich/assets/mint/btn.png" alt="" />
