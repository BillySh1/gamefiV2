      ...
      <div class="left_c">
        <div class="img_box">
          <img
            ...
            :src="info.img"
          />
          <img class="img_bg" src="https://cryptorich3.mypinata.cloud/ipfs/QmYcwx7pKcH9y9kFCwx2pswmvjGSFPLPDv2Ld8SovipH2h/rich/assets/store/buy_item_bg.png" />
        </div>
      </div>
      <div class="right_c">
        <img class="blood" src="https://cryptorich3.mypinata.cloud/ipfs/QmYcwx7pKcH9y9kFCwx2pswmvjGSFPLPDv2Ld8SovipH2h/rich/assets/mint/blood.png" alt="" />
        <div class="right_c_title">
          ...
          <div class="right_c_price">
            <img
              ...
              :src="
                payment == 1
                  ? 'https://cryptorich3.mypinata.cloud/ipfs/QmYcwx7pKcH9y9kFCwx2pswmvjGSFPLPDv2Ld8SovipH2h/rich/assets/exchange/coin.png'
                  : 'https://cryptorich3.mypinata.cloud/ipfs/QmYcwx7pKcH9y9kFCwx2pswmvjGSFPLPDv2Ld8SovipH2h/rich/assets/common/mmc.png'
              "
            />
        ...
        <div class="right_c_action">
          <div class="input_box">
            ...
            />
            <div class="ipt_bg">
              <img class="ipt_img" src="https://cryptorich3.mypinata.cloud/ipfs/QmYcwx7pKcH9y9kFCwx2pswmvjGSFPLPDv2Ld8SovipH2h/rich/assets/mint/input.png" alt="" />
              <input
                v-model="buyValue"
                class="input"
                @input="
          ...
          <div class="right_c_btn" @click="btnClick">
            <img class="btn_img" src="https://cryptorich3.mypinata.cloud/ipfs/QmYcwx7pKcH9y9kFCwx2pswmvjGSFPLPDv2Ld8SovipH2h/rich/assets/mint/btn.png" alt="" />
