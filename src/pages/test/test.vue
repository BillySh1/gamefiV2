<template>
  <div v-if="!loading" class="box">
    <InjectGoBack />
    <img class="badge" src="https://cryptorich3.mypinata.cloud/ipfs/QmYcwx7pKcH9y9kFCwx2pswmvjGSFPLPDv2Ld8SovipH2h/rich/assets/common/hero_sit.png" alt="" />
    <img class="logo" src="https://cryptorich3.mypinata.cloud/ipfs/QmYcwx7pKcH9y9kFCwx2pswmvjGSFPLPDv2Ld8SovipH2h/rich/assets/common/logo.png" alt="" />
