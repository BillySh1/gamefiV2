      ...
      <div class="main">
        ...
        <div class="card_content">
          <div
            ...
            "
          >
            <img src="https://cryptorich3.mypinata.cloud/ipfs/QmYcwx7pKcH9y9kFCwx2pswmvjGSFPLPDv2Ld8SovipH2h/rich/assets/store/left.png" alt="" />
          </div>
          ...
          <div
            ...
            "
          >
            <img src="https://cryptorich3.mypinata.cloud/ipfs/QmYcwx7pKcH9y9kFCwx2pswmvjGSFPLPDv2Ld8SovipH2h/rich/assets/store/right.png" alt="" />
          </div>
        </div>
      </div>
    </div>
    <div v-else class="inner">
      <div class="search_box">
        ...
        <img
          @click="onSearch()"
          style="width: 2rem"
          src="https://cryptorich3.mypinata.cloud/ipfs/QmYcwx7pKcH9y9kFCwx2pswmvjGSFPLPDv2Ld8SovipH2h/rich/assets/pack/search.svg"
          alt=""
        />
      </div>
    </div>
...
.container {
  ...
  width: 100%;
  height: 100%;
  background: url("https://cryptorich3.mypinata.cloud/ipfs/QmYcwx7pKcH9y9kFCwx2pswmvjGSFPLPDv2Ld8SovipH2h/rich/assets/pack/pack_hero_bg.svg") no-repeat;
