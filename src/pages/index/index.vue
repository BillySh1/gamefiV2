    ...
    <div class="content">
      ...
      <div class="float_right_box">
        <div class="flex">
          <div class="float_item" @click="jump('airdrop')">
            <InjectIcon
              :src="'https://cryptorich3.mypinata.cloud/ipfs/QmcFsLUaLoDqCKoQsHompg1stZheKthySUPkbndKTBPs1y/rich/assets/index/airdrop.png'"
              :text="t('airdrop')"
            />
          </div>
          <!-- <div class="float_item">
            <div class="float_item" @click="jump('invite')">
              <InjectIcon
                :src="'https://cryptorich3.mypinata.cloud/ipfs/QmcFsLUaLoDqCKoQsHompg1stZheKthySUPkbndKTBPs1y/rich/assets/index/invite.png'"
                :text="t('invite')"
              />
            </div>
          </div> -->
      ...
      <div class="float_left_box">
        <div class="leader_board_box" @click="jump('leader')">
          <img
            src="https://cryptorich3.mypinata.cloud/ipfs/QmcFsLUaLoDqCKoQsHompg1stZheKthySUPkbndKTBPs1y/rich/assets/index/Leader_board.svg"
            alt=""
          />
