<template>
  <div v-if="value" class="detail_container">
    <img class="bg" src="https://cryptorich3.mypinata.cloud/ipfs/QmYcwx7pKcH9y9kFCwx2pswmvjGSFPLPDv2Ld8SovipH2h/rich/assets/pack/pack_container.svg" alt="" />

    <div class="inner">
      <div class="inner_box">
        <div class="detail_back" @click="$emit('back')">
          <img src="https://cryptorich3.mypinata.cloud/ipfs/QmYcwx7pKcH9y9kFCwx2pswmvjGSFPLPDv2Ld8SovipH2h/rich/assets/pack/pack_back.svg" alt="" />
        </div>
        <div class="tab_box">
          <div
            v-for="item in tabs"
          ...
          >
            <img
              ...
              src="https://cryptorich3.mypinata.cloud/ipfs/QmYcwx7pKcH9y9kFCwx2pswmvjGSFPLPDv2Ld8SovipH2h/rich/assets/pack/active_tab_item.png"
              alt=""
            />
            <img
              class="in_active"
              v-show="item.key != curTab"
              src="https://cryptorich3.mypinata.cloud/ipfs/QmYcwx7pKcH9y9kFCwx2pswmvjGSFPLPDv2Ld8SovipH2h/rich/assets/pack/common_tab_item.png"
              alt=""
            />
            <div>
        ...
        <div class="content_box">
          <div class="inner">
            ...
            >
              <img src="https://cryptorich3.mypinata.cloud/ipfs/QmYcwx7pKcH9y9kFCwx2pswmvjGSFPLPDv2Ld8SovipH2h/rich/assets/pack/common_pack_item_bg.svg" alt="" />
        ...
        <div class="detail_box">
          <div class="inner">
            <div class="up">
              <div class="left">
                <img src="https://cryptorich3.mypinata.cloud/ipfs/QmYcwx7pKcH9y9kFCwx2pswmvjGSFPLPDv2Ld8SovipH2h/rich/assets/pack/detail_stock_box.png" alt="" />
                <img
                  v-if="curItemShow"
                  class="content"
                  :src="curItemShow.img"
