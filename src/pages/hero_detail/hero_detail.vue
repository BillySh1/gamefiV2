  ...
  <div class="hero_detail_box">
    ...
    <div v-else class="inner">
      ...
      <div class="info_box">
        <img
          class="bg"
          src="https://cryptorich3.mypinata.cloud/ipfs/QmTLaiRRXJ1BaDbxb92T3cfyN9xMMyD1GuWaxHXGQSFhQg/rich/assets/pack/detial_bg.png"
          alt=""
        />
        <div class="inner">
          <div class="up_box">
          ...
          <div class="bottom_box">
            ...
            <div v-if="curTabKey == 1" class="quick_info">
              ...
              <div class="chain_info">
                ...
                >
                  <img
                    src="https://cryptorich3.mypinata.cloud/ipfs/QmTLaiRRXJ1BaDbxb92T3cfyN9xMMyD1GuWaxHXGQSFhQg/rich/assets/pack/ab_box.png"
                  />
            ...
            <div v-if="curTabKey == 2" class="attributes">
              <div class="attributes_detail">
                ...
                >
                  <img
                    :src="`https://cryptorich3.mypinata.cloud/ipfs/QmTLaiRRXJ1BaDbxb92T3cfyN9xMMyD1GuWaxHXGQSFhQg/rich/assets/pack/p_${index}.png`"
                    alt=""
                  />
              ...
              <img
                class="divider"
                src="https://cryptorich3.mypinata.cloud/ipfs/QmTLaiRRXJ1BaDbxb92T3cfyN9xMMyD1GuWaxHXGQSFhQg/rich/assets/pack/divider.png"
                alt=""
              />
              <div class="attr_map">
      ...
      <div class="action_box">
        ...
        >
          <img
            src="https://cryptorich3.mypinata.cloud/ipfs/QmTLaiRRXJ1BaDbxb92T3cfyN9xMMyD1GuWaxHXGQSFhQg/rich/assets/pack/yellow.png"
            alt=""
          />
        ...
        >
          <img
            src="https://cryptorich3.mypinata.cloud/ipfs/QmTLaiRRXJ1BaDbxb92T3cfyN9xMMyD1GuWaxHXGQSFhQg/rich/assets/pack/blue.png"
            alt=""
          />
...
.hero_detail_box {
  ...
  width: 100%;
  height: 100%;
  background: url("https://cryptorich3.mypinata.cloud/ipfs/QmTLaiRRXJ1BaDbxb92T3cfyN9xMMyD1GuWaxHXGQSFhQg/rich/assets/hero_detail/hero_detail_bg.png");
