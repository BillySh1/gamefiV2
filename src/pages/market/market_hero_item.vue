    ...
    <div class="power_zone">
      <div class="zone_inner">
        <div class="value_box">
          <img
            class="part"
            src="https://cryptorich3.mypinata.cloud/ipfs/QmYcwx7pKcH9y9kFCwx2pswmvjGSFPLPDv2Ld8SovipH2h/rich/assets/pack/power_text_left.svg"
            alt=""
          />
          <div class="text">
          ...
          <img
            class="part"
            src="https://cryptorich3.mypinata.cloud/ipfs/QmYcwx7pKcH9y9kFCwx2pswmvjGSFPLPDv2Ld8SovipH2h/rich/assets/pack/power_text_right.svg"
            alt=""
          />
        </div>
