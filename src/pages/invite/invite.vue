  ...
  <div class="container">
    ...
    <div class="content">
      ...
      <div class="invite_box">
        <div class="up">
          <img
            src="https://bafybeickixvp7jbv6tbrhv7xklr5vy2t6j6qgvf6maugc5xrvmj6tocd3u.ipfs.4everland.io/rich/assets/invite/up_bg.png"
            alt=""
          />
          <div
            class="info_box"
        ...
        <div class="bottom_box">
          ...
          >
            <img
              src="https://bafybeickixvp7jbv6tbrhv7xklr5vy2t6j6qgvf6maugc5xrvmj6tocd3u.ipfs.4everland.io/rich/assets/invite/item_1.png"
              alt=""
            />
            <div class="inner">
              <img
                src="https://bafybeickixvp7jbv6tbrhv7xklr5vy2t6j6qgvf6maugc5xrvmj6tocd3u.ipfs.4everland.io/rich/assets/invite/icons/2.svg"
                alt=""
              />
              {{ t("invite_board") }}
            </div>
          ...
          <div class="item" @click="() => (showRules = true)">
            <img
              src="https://bafybeickixvp7jbv6tbrhv7xklr5vy2t6j6qgvf6maugc5xrvmj6tocd3u.ipfs.4everland.io/rich/assets/invite/item_2.png"
              alt=""
            />
            <div class="inner">
              <img
                src="https://bafybeickixvp7jbv6tbrhv7xklr5vy2t6j6qgvf6maugc5xrvmj6tocd3u.ipfs.4everland.io/rich/assets/invite/icons/3.svg"
                alt=""
              />
              {{ t("invite_rule") }}
            </div>
          ...
          <div class="item" @click="generate">
            <img
              src="https://bafybeickixvp7jbv6tbrhv7xklr5vy2t6j6qgvf6maugc5xrvmj6tocd3u.ipfs.4everland.io/rich/assets/invite/item_3.png"
              alt=""
            />
            <div class="inner">
              <img
                src="https://bafybeickixvp7jbv6tbrhv7xklr5vy2t6j6qgvf6maugc5xrvmj6tocd3u.ipfs.4everland.io/rich/assets/invite/icons/4.svg"
                alt=""
              />
              {{ t("generate_invite") }}
            </div>
