<template>
  ...
  <div class="box">
    ...
    :class="getPosDirection"
      v-if="player.isBond"
      :style="curPosition"
      src="https://www.rich3kingdoms.xyz/ipns/k51qzi5uqu5dgrl028jw0vu9g92no96w74irny1skee8oaok5jezrpkq4idajv/rich/allstar_assets/main/pos.gif"
      alt=""
    />
    ...
    <div class="main">
      <div class="inner">
        ...
        >
          ...
          >
            <div class="inner">
              ...
              <img
                class="p"
                src="https://www.rich3kingdoms.xyz/ipns/k51qzi5uqu5dgrl028jw0vu9g92no96w74irny1skee8oaok5jezrpkq4idajv/rich/allstar_assets/main/city_img.png"
                alt=""
              />
        ...
        >
          ...
          >
            <img
              src="https://www.rich3kingdoms.xyz/ipns/k51qzi5uqu5dgrl028jw0vu9g92no96w74irny1skee8oaok5jezrpkq4idajv/rich/allstar_assets/main/power_zone.png"
              alt=""
            />
          ...
          <div v-if="player.baseSpeed != 0" class="random_events">
            <img
              src="https://www.rich3kingdoms.xyz/ipns/k51qzi5uqu5dgrl028jw0vu9g92no96w74irny1skee8oaok5jezrpkq4idajv/rich/allstar_assets/main/speed.png"
              alt=""
            />
            当前速度 {{ curSpeed }}
          </div>
          ...
          >
            <img
              src="https://www.rich3kingdoms.xyz/ipns/k51qzi5uqu5dgrl028jw0vu9g92no96w74irny1skee8oaok5jezrpkq4idajv/rich/allstar_assets/main/clock.png"
              alt=""
            />
            {{ item.name }}
          </div>
        ...
        <div class="right_bottom">
          <div class="refresh_field" @click="allInit">
            <div class="inner">
              <img
                src="https://www.rich3kingdoms.xyz/ipns/k51qzi5uqu5dgrl028jw0vu9g92no96w74irny1skee8oaok5jezrpkq4idajv/rich/allstar_assets/main/to_final.png"
                alt=""
              />
...
export default {
  ...
  setup() {
    ...
    const getMap = computed(() => {
      return [
        "https://www.rich3kingdoms.xyz/ipns/k51qzi5uqu5dgrl028jw0vu9g92no96w74irny1skee8oaok5jezrpkq4idajv/rich/allstar_assets/main/map_0.png",
        "https://www.rich3kingdoms.xyz/ipns/k51qzi5uqu5dgrl028jw0vu9g92no96w74irny1skee8oaok5jezrpkq4idajv/rich/allstar_assets/main/map_1.png",
        "https://www.rich3kingdoms.xyz/ipns/k51qzi5uqu5dgrl028jw0vu9g92no96w74irny1skee8oaok5jezrpkq4idajv/rich/allstar_assets/main/map_2.png",
        "https://www.rich3kingdoms.xyz/ipns/k51qzi5uqu5dgrl028jw0vu9g92no96w74irny1skee8oaok5jezrpkq4idajv/rich/allstar_assets/main/map_3.png",
      ][data.curCamp];
    });
...
.top_left {
  ...
  .city_main {
    ...
    width: 7rem;
    height: 15rem;
    background: url("https://www.rich3kingdoms.xyz/ipns/k51qzi5uqu5dgrl028jw0vu9g92no96w74irny1skee8oaok5jezrpkq4idajv/rich/allstar_assets/main/main_camp.png")
      no-repeat;
...
.pack_btn {
  ...
  width: 5rem;
  height: 5rem;
  background: url("https://www.rich3kingdoms.xyz/ipns/k51qzi5uqu5dgrl028jw0vu9g92no96w74irny1skee8oaok5jezrpkq4idajv/rich/allstar_assets/main/pack_bg.png")
    no-repeat;
  background-size: 100% 100%;
  font-size: 1rem;
  display: flex;
