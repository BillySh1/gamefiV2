<template>
  ...
  <div class="box">
    ...
    :class="getPosDirection"
      v-if="player.isBond"
      :style="curPosition"
      src="https://bafybeickixvp7jbv6tbrhv7xklr5vy2t6j6qgvf6maugc5xrvmj6tocd3u.ipfs.4everland.io/rich/allstar_assets/main/pos.gif"
      alt=""
    />
    ...
    <div class="main">
      <div class="inner">
        ...
        >
          ...
          >
            <div class="inner">
              ...
              <img
                class="p"
                src="https://bafybeickixvp7jbv6tbrhv7xklr5vy2t6j6qgvf6maugc5xrvmj6tocd3u.ipfs.4everland.io/rich/allstar_assets/main/city_img.png"
                alt=""
              />
        ...
        >
          ...
          >
            <img
              src="https://bafybeickixvp7jbv6tbrhv7xklr5vy2t6j6qgvf6maugc5xrvmj6tocd3u.ipfs.4everland.io/rich/allstar_assets/main/power_zone.png"
              alt=""
            />
          ...
          <div v-if="player.baseSpeed != 0" class="random_events">
            <img
              src="https://bafybeickixvp7jbv6tbrhv7xklr5vy2t6j6qgvf6maugc5xrvmj6tocd3u.ipfs.4everland.io/rich/allstar_assets/main/speed.png"
              alt=""
            />
            当前速度 {{ curSpeed }}
          </div>
...
.top_left {
  ...
  .city_main {
    ...
    width: 7rem;
    height: 15rem;
    background: url("https://bafybeickixvp7jbv6tbrhv7xklr5vy2t6j6qgvf6maugc5xrvmj6tocd3u.ipfs.4everland.io/rich/allstar_assets/main/main_camp.png")
      no-repeat;
...
.pack_btn {
  ...
  width: 5rem;
  height: 5rem;
  background: url("https://bafybeickixvp7jbv6tbrhv7xklr5vy2t6j6qgvf6maugc5xrvmj6tocd3u.ipfs.4everland.io/rich/allstar_assets/main/pack_bg.png")
    no-repeat;
  background-size: 100% 100%;
  font-size: 1rem;
  display: flex;
