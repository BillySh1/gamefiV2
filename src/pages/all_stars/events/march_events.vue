      ...
      <div class="inner">
        ...
        <div class="main">
          ...
          <div class="bottom">
            <div class="img_box">
              <img
                src="https://cryptorich3.mypinata.cloud/ipfs/QmcFsLUaLoDqCKoQsHompg1stZheKthySUPkbndKTBPs1y/rich/allstar_assets/popups/img_bg.png"
                alt=""
              />
              <div class="img_inner">
                <img
                  v-if="type == 0"
                  src="https://cryptorich3.mypinata.cloud/ipfs/QmcFsLUaLoDqCKoQsHompg1stZheKthySUPkbndKTBPs1y/rich/allstar_assets/popups/insert_0.png"
                  alt=""
                />
                <img
                  v-if="type == 5 || type == 'ing'"
                  src="https://cryptorich3.mypinata.cloud/ipfs/QmcFsLUaLoDqCKoQsHompg1stZheKthySUPkbndKTBPs1y/rich/allstar_assets/popups/insert_3.png"
                  alt=""
                />
              </div>
            </div>
