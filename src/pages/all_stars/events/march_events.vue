<template>
  ...
  >
    <img
      style="width: 100%"
      src="https://cryptorich3.mypinata.cloud/ipfs/QmYcwx7pKcH9y9kFCwx2pswmvjGSFPLPDv2Ld8SovipH2h/rich/allstar_assets/popups/light_bg.png"
      alt=""
    />
    <img
      @click="() => $emit('close')"
      ...
      <div class="inner">
        ...
        <div class="main">
          ...
          <div class="bottom">
            <div class="img_box">
              <img
                src="https://cryptorich3.mypinata.cloud/ipfs/QmYcwx7pKcH9y9kFCwx2pswmvjGSFPLPDv2Ld8SovipH2h/rich/allstar_assets/popups/img_bg.png"
                alt=""
              />
              <div class="img_inner">
                <img
                  v-if="type == 0"
                  src="https://cryptorich3.mypinata.cloud/ipfs/QmYcwx7pKcH9y9kFCwx2pswmvjGSFPLPDv2Ld8SovipH2h/rich/allstar_assets/popups/insert_0.png"
                  alt=""
                />
                <img
                  v-if="type == 5 || type == 'ing'"
                  src="https://cryptorich3.mypinata.cloud/ipfs/QmYcwx7pKcH9y9kFCwx2pswmvjGSFPLPDv2Ld8SovipH2h/rich/allstar_assets/popups/insert_3.png"
                  alt=""
                />
              </div>
            </div>
    ...
    <div :class="btnDisable ? 'confirm disable' : 'confirm'" @click="onConfirm">
      <div class="inner">
        <img
          src="https://cryptorich3.mypinata.cloud/ipfs/QmYcwx7pKcH9y9kFCwx2pswmvjGSFPLPDv2Ld8SovipH2h/rich/allstar_assets/popups/confirm_bg.png"
          alt=""
        />
