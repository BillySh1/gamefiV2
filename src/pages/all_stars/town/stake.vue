  ...
  <div v-else class="box">
    ...
    >
      <div class="rule_modal_item">
        ...
        <img
          style="width: 4rem"
          src="https://cryptorich3.mypinata.cloud/ipfs/QmYcwx7pKcH9y9kFCwx2pswmvjGSFPLPDv2Ld8SovipH2h/rich/assets/store/item/type_0_0.png"
          alt=""
        />
        数量：
        {{ cost[0] }}
      ...
      <div class="rule_modal_item">
        ...
        <img
          style="width: 4rem"
          src="https://cryptorich3.mypinata.cloud/ipfs/QmYcwx7pKcH9y9kFCwx2pswmvjGSFPLPDv2Ld8SovipH2h/rich/assets/store/item/type_0_1.png"
          alt=""
        />
        数量：
        {{ cost[1] }}
    ...
    <div class="topbar">
      <div class="title">
        <img
          src="https://cryptorich3.mypinata.cloud/ipfs/QmYcwx7pKcH9y9kFCwx2pswmvjGSFPLPDv2Ld8SovipH2h/rich/allstar_assets/store/title_bg.png"
          alt=""
        />
      ...
      <div class="power">
        <img
          src="https://cryptorich3.mypinata.cloud/ipfs/QmYcwx7pKcH9y9kFCwx2pswmvjGSFPLPDv2Ld8SovipH2h/rich/allstar_assets/stake/power_bg.png"
          alt=""
        />
      ...
      <div class="rule" @click="() => (showRuleModal = true)">
        <img
          src="https://cryptorich3.mypinata.cloud/ipfs/QmYcwx7pKcH9y9kFCwx2pswmvjGSFPLPDv2Ld8SovipH2h/rich/allstar_assets/stake/rule_bg.png"
          alt=""
        />
    ...
    <div class="main_already" v-show="Number(player.baseSpeed) > 0">
      <div class="already_item">
        <div class="top">
          <img
            style="height: 6rem"
            src="https://cryptorich3.mypinata.cloud/ipfs/QmYcwx7pKcH9y9kFCwx2pswmvjGSFPLPDv2Ld8SovipH2h/rich/allstar_assets/stake/wujiang.png"
            alt=""
          />
          <div>总战力值</div>
          <div>
      ...
      <div class="already_item">
        <div class="top">
          <img
            style="height: 6rem"
            src="https://cryptorich3.mypinata.cloud/ipfs/QmYcwx7pKcH9y9kFCwx2pswmvjGSFPLPDv2Ld8SovipH2h/rich/allstar_assets/stake/zhugong.png"
            alt=""
          />
          <div>总战力值</div>
          <div>
  ...
  setup() {
    ...
    const data = reactive({
      tabs: [
        {
          key: 0,
          img: "https://cryptorich3.mypinata.cloud/ipfs/QmYcwx7pKcH9y9kFCwx2pswmvjGSFPLPDv2Ld8SovipH2h/rich/allstar_assets/stake/wujiang.png",
          next: 1,
        },
        {
          key: 1,
          img: "https://cryptorich3.mypinata.cloud/ipfs/QmYcwx7pKcH9y9kFCwx2pswmvjGSFPLPDv2Ld8SovipH2h/rich/allstar_assets/stake/zhugong.png",
          next: 0,
        },
      ],
      activeTab: 0,
...
.box {
  ...
  background: url("https://cryptorich3.mypinata.cloud/ipfs/QmYcwx7pKcH9y9kFCwx2pswmvjGSFPLPDv2Ld8SovipH2h/rich/allstar_assets/stake/stake_bg.png")
    no-repeat;
