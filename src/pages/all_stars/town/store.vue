<template>
  ...
  <div class="box">
    <div class="inner">
      <div class="left">
        <div class="title">
          <img src="https://www.rich3kingdoms.xyz/ipns/k51qzi5uqu5dgrl028jw0vu9g92no96w74irny1skee8oaok5jezrpkq4idajv/rich/allstar_assets/store/title_bg.png" alt="" />
        ...
        <div class="boxDetail">
          <div class="item" v-for="item in boxMap" :key="item.key">
            ...
            <div class="intro">
              <img src="https://www.rich3kingdoms.xyz/ipns/k51qzi5uqu5dgrl028jw0vu9g92no96w74irny1skee8oaok5jezrpkq4idajv/rich/allstar_assets/store/0_bg.png" alt="" />
        ...
        <div class="back" @click="() => $router.go(-1)">
          <img src="https://www.rich3kingdoms.xyz/ipns/k51qzi5uqu5dgrl028jw0vu9g92no96w74irny1skee8oaok5jezrpkq4idajv/rich/allstar_assets/store/back.png" alt="" />
      ...
      <div class="right">
        <img src="https://www.rich3kingdoms.xyz/ipns/k51qzi5uqu5dgrl028jw0vu9g92no96w74irny1skee8oaok5jezrpkq4idajv/rich/allstar_assets/store/right_bg.png" alt="" />
        <div class="tab_box">
          <div
            class="item"
            v-for="item in tabs"
          ...
          >
            <img
              :src="
                item.key == curTab
                  ? 'https://www.rich3kingdoms.xyz/ipns/k51qzi5uqu5dgrl028jw0vu9g92no96w74irny1skee8oaok5jezrpkq4idajv/rich/allstar_assets/store/active_tab.png'
                  : 'https://www.rich3kingdoms.xyz/ipns/k51qzi5uqu5dgrl028jw0vu9g92no96w74irny1skee8oaok5jezrpkq4idajv/rich/allstar_assets/store/inactive_tab.png'
              "
              alt=""
            />
            <div class="text">
        ...
        <div class="inner">
          <div class="title_img">
            <img src="https://www.rich3kingdoms.xyz/ipns/k51qzi5uqu5dgrl028jw0vu9g92no96w74irny1skee8oaok5jezrpkq4idajv/rich/allstar_assets/store/box.png" alt="" />
          </div>
          <div class="name_price">
            ...
            <div class="price">
              <img src="https://www.rich3kingdoms.xyz/ipns/k51qzi5uqu5dgrl028jw0vu9g92no96w74irny1skee8oaok5jezrpkq4idajv/rich/assets/common/mmc.png" alt="" />
              {{ stockPrice }}
            </div>
          </div>
          <div class="action">
            <img src="https://www.rich3kingdoms.xyz/ipns/k51qzi5uqu5dgrl028jw0vu9g92no96w74irny1skee8oaok5jezrpkq4idajv/rich/allstar_assets/store/right_d_bg.png" alt="" />
            <div class="ac_inner">
              <div class="input_box">
                <img
  ...
  setup() {
    ...
    const data = reactive({
      ...
      boxMap: [
        {
          key: 0,
          img: "https://www.rich3kingdoms.xyz/ipns/k51qzi5uqu5dgrl028jw0vu9g92no96w74irny1skee8oaok5jezrpkq4idajv/rich/allstar_assets/store/0_0.png",
          name: "青铜骏马",
          color: "#B5B5B5",
        },
        {
          key: 1,
          img: "https://www.rich3kingdoms.xyz/ipns/k51qzi5uqu5dgrl028jw0vu9g92no96w74irny1skee8oaok5jezrpkq4idajv/rich/allstar_assets/store/0_1.png",
          name: "白金汗血",
          color: "#3F63C7",
        },
        {
          key: 2,
          img: "https://www.rich3kingdoms.xyz/ipns/k51qzi5uqu5dgrl028jw0vu9g92no96w74irny1skee8oaok5jezrpkq4idajv/rich/allstar_assets/store/0_2.png",
          name: "银狐牺尊",
          color: "#5D17AC",
        },
        {
          key: 3,
          img: "https://www.rich3kingdoms.xyz/ipns/k51qzi5uqu5dgrl028jw0vu9g92no96w74irny1skee8oaok5jezrpkq4idajv/rich/allstar_assets/store/0_3.png",
          name: "白神象彝",
          color: "#BA5F0F",
        },
        {
          key: 4,
          img: "https://www.rich3kingdoms.xyz/ipns/k51qzi5uqu5dgrl028jw0vu9g92no96w74irny1skee8oaok5jezrpkq4idajv/rich/allstar_assets/store/0_4.png",
          name: "龙刻陨星",
          color: "#FFDF3C",
        },
      ],
...
.box {
  ...
  background: url("https://www.rich3kingdoms.xyz/ipns/k51qzi5uqu5dgrl028jw0vu9g92no96w74irny1skee8oaok5jezrpkq4idajv/rich/allstar_assets/store/bf_store_bg.png") no-repeat;
