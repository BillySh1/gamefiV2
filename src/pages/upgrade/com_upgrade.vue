<template>
  <div class="com_box">
    <div class="power_box">
      <img src="https://www.rich3kingdoms.xyz/ipns/k51qzi5uqu5dgrl028jw0vu9g92no96w74irny1skee8oaok5jezrpkq4idajv/rich/assets/upgrade/power_bg.png" />
      <div class="inner">
        <div class="text">战力值</div>
        <div class="value">{{ info.power }}</div>
        <div class="pImg">
          <img src="https://www.rich3kingdoms.xyz/ipns/k51qzi5uqu5dgrl028jw0vu9g92no96w74irny1skee8oaok5jezrpkq4idajv/rich/assets/pack/power_item.png" alt="" />
        </div>
      </div>
    </div>
    <div class="cost_box" v-if="updateInfo.canLevelup">
      ...
      <img class="divider" src="https://www.rich3kingdoms.xyz/ipns/k51qzi5uqu5dgrl028jw0vu9g92no96w74irny1skee8oaok5jezrpkq4idajv/rich/assets/upgrade/divider.png" />
    </div>
    <div class="property_box" v-if="updateInfo.canLevelup">
      <img src="https://www.rich3kingdoms.xyz/ipns/k51qzi5uqu5dgrl028jw0vu9g92no96w74irny1skee8oaok5jezrpkq4idajv/rich/assets/upgrade/properties_bg.png" alt="" />
      <img class="badge" src="https://www.rich3kingdoms.xyz/ipns/k51qzi5uqu5dgrl028jw0vu9g92no96w74irny1skee8oaok5jezrpkq4idajv/rich/assets/upgrade/proper_badge.png" />
      <div class="inner">
        <div class="item">
    ...
    <div class="action_box" v-if="updateInfo.canLevelup">
      ...
      >
        <img src="https://www.rich3kingdoms.xyz/ipns/k51qzi5uqu5dgrl028jw0vu9g92no96w74irny1skee8oaok5jezrpkq4idajv/rich/assets/upgrade/action_bg.png" alt="" />
      ...
      >
        ...
        <img src="https://www.rich3kingdoms.xyz/ipns/k51qzi5uqu5dgrl028jw0vu9g92no96w74irny1skee8oaok5jezrpkq4idajv/rich/assets/upgrade/action_bg_1.png" alt="" />
      </div>
    </div>
      ...
      >
        <div class="modal_inner_box">
          ...
          <div class="main">
            ...
            <div class="middle">
              <img src="https://www.rich3kingdoms.xyz/ipns/k51qzi5uqu5dgrl028jw0vu9g92no96w74irny1skee8oaok5jezrpkq4idajv/rich/assets/upgrade/right.png" alt="" />
            </div>
            <div class="item">
...
.com_box {
  width: 100%;
  height: 100%;
  background: url("https://www.rich3kingdoms.xyz/ipns/k51qzi5uqu5dgrl028jw0vu9g92no96w74irny1skee8oaok5jezrpkq4idajv/rich/assets/upgrade/over_bg.png") no-repeat;
