  ...
  <div class="container">
    ...
    <div v-if="!loading" class="content">
      ...
      <div class="operate_box">
        ...
        <img class="divider" src="https://www.rich3kingdoms.xyz/ipns/k51qzi5uqu5dgrl028jw0vu9g92no96w74irny1skee8oaok5jezrpkq4idajv/rich/assets/upgrade/divider_tab.png" />
        ...
        <div class="tabs_box">
          <div
            ...
            "
          >
            <img src="https://www.rich3kingdoms.xyz/ipns/k51qzi5uqu5dgrl028jw0vu9g92no96w74irny1skee8oaok5jezrpkq4idajv/rich/assets/upgrade/tab_bg.png" />
            <div class="inner">
              {{ item }}
            </div>
          </div>
    ...
    >
      <div class="inner">
        <img src="https://www.rich3kingdoms.xyz/ipns/k51qzi5uqu5dgrl028jw0vu9g92no96w74irny1skee8oaok5jezrpkq4idajv/rich/assets/common/tip_badge.svg" />
        <div class="text">前往商城</div>
      </div>
    </div>
    <img class="bg_badge" src="https://www.rich3kingdoms.xyz/ipns/k51qzi5uqu5dgrl028jw0vu9g92no96w74irny1skee8oaok5jezrpkq4idajv/rich/assets/pack/bg_badge.svg" />
  </div>
</template>
